    ...
    const fetchSneakerDetails = async () => {
      try {
        const { data } = await axios.get(
          `https://d0a241b6583b9f48.mokky.dev/sneakers/${id}`
        );
        setSneaker(data);
        setLoading(false);
      } catch (err) {
          ...
          <div className="details-right-block">
            <div className="details-top-art-stock">
              ...
              <p className="details-articul">
                В наличии:{" "}
                <span className="details-count-stock">
                  {sneaker.inStock} шт
                </span>
              </p>
            </div>
            ...
            <Link
              ...
              onClick={() => handleOverlayClick(sneaker)}>
              Заказать
            </Link>
        ...
        <div className="details-under-block">
          <div className="details-interpreter">
            ...
            <div className="details-description">
              <p className="details-under-text text-description">
                {sneaker.description}
              </p>
            </div>
          </div>
