...
export default function FourthForm() {
  ...
  return (
    <div className="choose-lastform">
      <h2 className="choose-heading choose-last-heading">
        Ваша подборка готова!
      </h2>
      <p className="choose-last-description">
        Оставьте свои контактные данные, чтобы мы могли отправить подготовленный
        для вас каталог
      </p>
      <div className="display">
        <div className="choose-input-form">
          <div className="choose-list">
            ...
            <div>
              ...
              />
              {errors.name && (
                <p className="choose-error-message">
        ...
        {isShow && (
          <img src={otpravleno} alt="" className="choose-otpravleno" />
        )}
      </div>
    </div>
  );
